export const reasignarMailOptionsClients = (data: any) => {
    return {
        from: `CENTRO DE SERVICIO <carlos.ballesteros@ipejal.gob.mx>`,
                to: data.correoCliente,
                subject: `Reabierto - El ticket #${data.idTicket} fue reabierto.`,
                html: `
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                    Gracias por ponerte en contacto con la Mesa de Servicio de la dirección de informática del Instituto de Pensiones del Estado de Jalisco (IPEJAL).
                                    </p>
                                    <p
                                      style="
                                        margin: 0;
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                    La descripción de tu solicitud es la siguiente:
                                    </p>
                                    <p
                                      style="
                                        margin: 0;
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                    Nuestros especialistas están trabajando para brindarte la mejor solución.
                                    </p>
                                    <p
                                      style="
                                        margin: 0;
                                      ...
                                      "
                                    >
                                    Si deseas agregar comentarios, responde a este correo electrónico.
                                    </p>
                                    <p
                                      style="
                                        margin: 0;
...
export const reasignarMailOptionsUser = (data: any) => {
    return {
        from: `CENTRO DE SERVICIO <carlos.ballesteros@ipejal.gob.mx>`,
                to: data.correoUsuario,
                subject: `Reabierto - Has sido designado propietario de Incidencia #${data.idTicket}`,
                html: `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="es">
 <head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta content="telephone=no" name="format-detection">
  <title>Mesa de Servicio</title><!--[if (mso 16)]>
    <style type="text/css">
    a {text-decoration: none;}
    </style>
    <![endif]--><!--[if gte mso 9]><style>sup { font-sizea: 100% !important; }</style><![endif]--><!--[if gte mso 9]>
<noscript>
         <xml>
           <o:OfficeDocumentSettings>
           <o:AllowPNG></o:AllowPNG>
                   ...
                   <table width="100%" role="presentation" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0">
                       <div style="border-radius:8px;width:auto;color:white;padding:10px;background-color:#7557C1;text-align:center">
                        <strong>El ticket #${data.idTicket} fue reabierto</strong>
                       </div></td>
                     </tr>
                   </table></td>
                 </tr>
                 ...
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">Estimado miembro del equipo de resolución de incidentes de la Mesa de Servicio de la dirección de informática del Instituto de Pensiones del Estado de Jalisco (IPEJAL).</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">Te hemos asignado el ticket <strong>#${data.idTicket}</strong> que corresponde a la siguiente solicitud:</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify;margin-left:40px">&nbsp;<em>"${data.descripcionTicket}"</em></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify;margin-left:40px"><em><br></em></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">Responde a <strong>${data.nombreCliente}.</strong></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify"><strong></strong>Sus datos de contacto son los siguientes: &nbsp; &nbsp;</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify;margin-left:40px"><strong>Teléfono:</strong> ${data.telefonoCliente} <strong>ext:</strong> ${data.extensionCliente}</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify;margin-left:40px"><strong>Ubicación:</strong> ${data.ubicacion} &nbsp; &nbsp; &nbsp;</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify;margin-left:40px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">Te solicitamos indicar en el espacio correspondiente de la manera más clara posible, cuál fue la solución que le brindaste al usuario; esto nos será útil para dar retroalimentación en caso de que sea necesario.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;text-align:justify">Gracias por tu atención.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0"><a target="_blank" href="*|FORWARD|*" style="mso-line-height-rule:exactly;text-decoration:underline;color:#1376C8;font-size:14px"><img width="560" src="https://furvfgx.stripocdn.email/content/guids/CABINET_0e753cd3dd36d531f430fe66db6003bbfd8b0bbce9fdde10196618e13263350f/images/firma_mesa.png" alt="" class="adapt-img" height="141" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></a></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
