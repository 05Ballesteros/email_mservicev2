export const regresarMailOptions = (data: any) => {
  return {
    from: `CENTRO DE SERVICIO <carlos.ballesteros@ipejal.gob.mx>`,
    to: data.correoResolutor,
    subject: `Devuelto - El ticket #${data.idTicket} fue devuelto a mesa.`,
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      Estimado miembro del equipo de resolución
                                      de incidentes de la Mesa de Servicio de la
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      &nbsp;<em>"${data.descripcionTicketRegresado}"</em>
                                    </p>
                                    <p
                                      style="
                                        margin: 0;
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      <strong></strong>Sus datos de contacto son
                                      los siguientes: &nbsp; &nbsp;
                                    </p>
                                    <p
                                      style="
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      Te solicitamos indicar en el espacio
                                      correspondiente de la manera más clara
                                      posible, cuál fue la solución que le
                                      brindaste al usuario; esto nos será útil
                                      para dar retroalimentación en caso de que
                                      sea necesario.
                                    </p>
                                    <p
                                      style="
